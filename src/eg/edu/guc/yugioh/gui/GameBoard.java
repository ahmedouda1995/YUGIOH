...
public class GameBoard extends JFrame{
	...
	public GameBoard(Player p1, Player p2) throws Exception{
		...
		pic.setPreferredSize(new Dimension(200,333));
		...
		text.setPreferredSize(new Dimension(200,333));left.add(scroller,BorderLayout.WEST);
         main1 = new JLabel("<html><br>Main 1</html>");
         main1.setOpaque(false);
         main1.setBackground(null);
         
         main1.setFont(new Font("PerryGothic",Font.BOLD,20));
         main2 = new JLabel("<html><br>Main 2</html>");
         main2.setFont(new Font("PerryGothic",Font.BOLD,20));
        ...
        battle.setFont(new Font("PerryGothic",Font.BOLD,20));
